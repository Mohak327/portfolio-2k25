...
export const homeData = {
  ...
  hero: {
    ...
    buttons: [
      { text: "Contact Me", type: "primary" as const, href: "#contact" },
    ...
    jobs: [
      {
        ...
        tasks: [
          ...
          "Rebuilt the <span class='highlight'>hierarchical Bayes conjoint estimator</span> from scratch in NumPy (Gibbs sampling on the population mean and covariance, Metropolis-Hastings on respondent-level coefficients, constraints enforced inside the sampler rather than filtered post-hoc), then built per-respondent willingness-to-pay on top of it: a full distribution rather than a point estimate, suppressed entirely when no monetary attribute exists rather than approximated.",
          "Designed and shipped the Market Simulator, <span class='highlight'>an interactive what-if engine for market share, revenue, and price-sensitivity analysis</span>, with a Pareto Frontier view ranking every re-priced scenario by non-dominated sorting across three competing objectives.",
          "Built the <span class='highlight'>human-baseline fidelity reporting layer</span> over a <span class='highlight'>154-study social-science replication corpus</span>, benchmarking published AMCEs against four independent estimators, and shipped Concept Testing, a second experiment type built around <span class='highlight'>direct concept evaluation</span> rather than attribute trade-offs.",
          "Owned the supporting platform: LLM provider migration across Bedrock, Grok, and Databricks, enterprise auth (Auth0 org SSO, role-based access), a unified network layer, and the test suite (golden tests for the Pareto and WTP math) shipped alongside every feature.",
        ],
